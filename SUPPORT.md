...
Thank you for using mcp-pm! We're here to help. Below are the available support channels.
...
- **README**: [README.md](README.md) — Quick start, features, architecture
- **中文文档**: [README.zh-CN.md](README.zh-CN.md) — 中文版说明文档

## Direct Contact

For private or sensitive inquiries:

- **Email**: [wgwcko@gmail.com](mailto:wgwcko@gmail.com)
- **Security Issues**: Please see [SECURITY.md](SECURITY.md) for our responsible disclosure policy
